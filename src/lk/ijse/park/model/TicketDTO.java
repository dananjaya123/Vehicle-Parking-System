...
public class TicketDTO {
    ...
    public TicketDTO(String tID, String rID, String psID, String paID, String check_In_Time, String check_In_Date, String customer_Name, String phone_Number, String check_Out_Time, String check_Out_Date) {
        this.tID = tID;
        this.rID = rID;
        this.psID = psID;
        this.paID = paID;
