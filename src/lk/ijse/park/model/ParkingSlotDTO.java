...
public class ParkingSlotDTO {
    ...
    public ParkingSlotDTO(String psID, String paID, String slot_Name, String Length, String widch) {
        this.psID = psID;
        this.paID = paID;
    ...
    public String toString() {
        return "parkinSlotDTO{" + "psID=" + psID + ", paID=" + paID + ", slot_Name=" + slot_Name + ", Length=" + Length + ", widch=" + widch + '}';
    }
